...
class ReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_non_billed_lane_cannot_invoke_models(self) -> None:
        ...
        self.assertIn("environment: mosaic-aurora-billed", release)
        self.assertIn("environment: mosaic-aurora-billed", billed)
        self.assertIn("scripts/validate_lab.py", model)
        self.assertIn("for lab in 1 2 3", model)
        self.assertNotIn("scripts/validate_lab.py", release)
