...
# reported separately. They are never selected automatically by the application.
# Account entitlement and the invoking role must be tested for each model; model
# discovery alone does not prove either. The model already passed as --chat is skipped.
CHAT_FALLBACKS = (
