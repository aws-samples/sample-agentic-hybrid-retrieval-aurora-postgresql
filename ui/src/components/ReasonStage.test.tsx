...
describe("ReasonStage grounded answer", () => {
  ...
  it("leads with the answer and keeps retrieval and evidence in distinct disclosures", async () => {
    ...
    const answer = screen.getByRole("region", { name: "Your agent answered with sources" });
  ...
  it("prints nothing about the answer, the plan or the citations before a run", () => {
    ...
    expect(screen.queryByRole("region", { name: "Your agent answered with sources" })).toBeNull();
...
describe("ReasonStage declined outcome", () => {
  ...
  it("renders the declined block above the chain and marks unreached rows as not reached", async () => {
    ...
    expect(screen.queryByText("Your agent answered with sources")).toBeNull();
  ...
  it("does not disturb a grounded run's chain or answer heading", async () => {
    ...
    expect(screen.getByText("Your agent answered with sources")).toBeTruthy();
