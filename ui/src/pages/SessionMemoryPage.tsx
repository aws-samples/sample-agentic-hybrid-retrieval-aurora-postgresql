...
export function SessionMemoryPage() {
  ...
  return <div className="page pipeline-inspector session-memory">
    ...
    <div className="inspector-intro"><MosaicLabsMasthead title="What stays with Alex." deck="A session holds the conversation. AgentCore Memory turns it into facts, preferences, summaries and lessons that can be recalled later." supportingText="An extension of the three labs, not part of them: Playground runs and lab proofs keep memory off, and nothing in Retrieve, Rank or Reason depends on this tab." /></div>
