...
export const api = {
  ...
  recallMemory: (query: string, sessionId?: string | null) => request<{ records: MemoryRecord[] }>("/api/session-memory/recall", { method: "POST", body: JSON.stringify({ query, session_id: sessionId ?? null }) }),
