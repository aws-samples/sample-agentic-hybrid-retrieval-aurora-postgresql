...
[Download Alex’s full-resolution headshot](../../ui/public/assets/images/mosaic/alex-headshot-v1.jpg).

Use the portrait beside the short bio, with plenty of space around both. The
square image works as a large circular crop or a simple rectangular photograph.
The Pipeline uses the same image at 128 CSS pixels on desktop.
...
[alex-portrait-v1.json](../../data/media/alex-portrait-v1.json).
