...
5. Explain Aurora PostgreSQL as the retrieval system of record.
...
| Time | Module | Output |
|---:|---|---|
| 0–5 | Environment check | API and Aurora reachable |
| 5–12 | Ingest source bundle | Objects, chunks, citations in Aurora |
