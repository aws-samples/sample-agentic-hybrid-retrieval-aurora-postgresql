...
5. Explain local PostgreSQL as the lab retrieval system of record, with the same schema patterns intended for Aurora PostgreSQL.
...
| Time | Module | Output |
|---:|---|---|
| 0–5 | Environment check | API and local PostgreSQL reachable |
